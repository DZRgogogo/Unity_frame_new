...
public class PlayerPrefsDataMgr : BaseManager<PlayerPrefsDataMgr>
{
    //: BaseManager<PlayerPrefsDataMgr>
    ...
    private void SaveValue(object value, string keyName)
    {
        ...
        // {
        //    Debug.Log("存储Array" + keyName);
        //    //父类装自来
        //    Array arr = value as Array;
        //    //先存字典长度
        //    PlayerPrefs.SetInt(keyName, arr.Length);
        //    //遍历存储Dic里面的具体值
        //    //用于区分 表示的 区分 key
        //    int index = 0;
        //    foreach (object _value in arr)
        //    {
        //        SaveValue(_value, keyName + "_value_" + index);
        //        ++index;
        //    }
        //}
